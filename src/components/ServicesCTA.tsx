...
export const ServicesCTA = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-r from-primary to-secondary text-white" aria-labelledby="cta-heading">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 id="cta-heading" className="font-telegraf font-bold text-2xl md:text-3xl mb-6">
