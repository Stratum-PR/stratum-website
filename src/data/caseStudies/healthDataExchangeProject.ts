...
export const healthDataExchangeProject = {
  ...
  metadata: {
    ...
    description: {
      en: 'How Stratum PR helped a public health agency automate and unify its lab reporting, case tracking, and public health response systems.',
      es: 'Cómo Stratum PR ayudó a una agencia de salud pública a automatizar y unificar sus sistemas de reporte de laboratorio, seguimiento de casos y respuesta de salud pública.'
    },
    keywords: {
  ...
  content: {
    en: {
      ...
      challenge: 'A public health crisis exposed deep fragmentation in the agency\'s data systems. Delays, duplication, and data silos impaired response efforts and resource allocation.',
      ...
      results: [
        ...
        'Recognized as a core data infrastructure by agency leadership'
      ],
    ...
    es: {
      ...
      client: 'Agencia de Salud Pública',
      ...
      challenge: 'Una crisis de salud pública reveló una fragmentación crítica en los sistemas de datos de la agencia. Retrasos, duplicación y silos de información afectaban la respuesta efectiva.',
      ...
      results: [
        ...
        'Reconocido como infraestructura clave por el liderazgo de la agencia'
      ],
