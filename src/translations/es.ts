...
export const esTranslations: Record<string, string> = {
  ...
  'home.hero.subtitle': '',
  'home.hero.description': 'Basada 100% en Puerto Rico, Stratum construye sistemas de datos inteligentes que reducen el trabajo manual y optimizan las operaciones sin necesidad de contratar a un equipo de manejo de datos.',
