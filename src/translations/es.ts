...
export const esTranslations: Record<string, string> = {
  ...
  'home.problem.box1.subtitle': 'La información crítica para las operaciones de tu negocio se encuentran dispersas en múltiples documentos, hojas de Excel, correos electrónicos y herramientas desconectadas.',
  'home.problem.box2.title': 'El Trabajo Manual Toma Demasiado Tiempo',
  'home.problem.box2.subtitle': 'Tu equipo tarda demasiadas horas en tareas administrativas y creación de reportes, dedicando menos tiempo al trabajo real.',
  ...
  'whyworkwithus.description': 'Fundada por consultores senior y especialistas en datos con años de experiencia entregando resultados, traemos la disciplina de equipos empresariales enormes en una firma enfocada y ágil construida para el impacto.',
  'whyworkwithus.expertise.title': 'Nuestra Experiencia',
  'whyworkwithus.expertise.description': 'Hemos diseñado sistemas, dashboards y herramientas de automatización para organizaciones en Puerto Rico y los Estados Unidos. Conocemos las implicaciones y cómo dar resultados.',
  ...
  'whyworkwithus.partnership.description': 'Trabajamos directamente con los líderes de cada organización, asegurando de cada proyecto se realice a la medida y esté a cargo de consultores senior.',
  ...
  'about.team.description': 'Nuestro equipo reúne mas de 18 años de experience en empresas Fortune 500, firmas consultoras, empresas de tecnología e instituciones académicas.',
  'about.team.expertise': 'EXPERIENCIA',
  
  // Team member data
  'team.jovaniel.name': 'Jovaniel Rodríguez Maldonado',
  'team.jovaniel.role': 'Co-Fundador, Infraestructura Tecnológica',
  'team.jovaniel.bio': 'Jovaniel aporta más de 10 años de experiencia en consultoría estratégica y análisis de datos, habiendo liderado varios proyectos en empresas Fortune 500. Su experiencia abarca manejo de proyectos, inteligencia empresarial, optimización de procesos y gestión del cambio organizacional.',
  'team.jovaniel.expertise': 'Consultoría Estratégica, Inteligencia Empresarial, Gestión del Cambio, Análisis de Datos',
  
  'team.genesis.name': 'Genesis Rodríguez Ortiz',
