          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {allTags.map((tag) => (
              <Button
                ...
                variant="outline"
                size="sm"
                className="font-telegraf hover:bg-primary hover:text-white transition-colors"
              >
                {tag}
              </Button>
            ))}
                ...
                <CardContent className="p-6">
                  <div className="flex flex-wrap gap-1 mb-3">
                    {study.tags.slice(0, 2).map((tag) => (
                      <span
                        key={tag}
                        className="px-2 py-1 text-xs font-telegraf bg-primary/10 text-primary rounded-full"
                      >
                        {tag}
                      </span>
                    ))}
