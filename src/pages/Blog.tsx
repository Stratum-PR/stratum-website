...
const Blog = () => {
  ...
  const { data: blogPosts, isLoading, error } = useAllBlogPosts(language);
      ...
      <div className="pt-20">
        <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="font-telegraf text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto mb-8">
              Sorry, we're having trouble loading our blog posts. Please try again later.
            </p>
